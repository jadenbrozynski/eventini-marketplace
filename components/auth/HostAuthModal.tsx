...
import { X, Heart, Star, CalendarCheck } from 'lucide-react';
...
export function HostAuthModal({ isOpen, onClose, onSuccess }: HostAuthModalProps) {
        ...
        <div className="p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">
              Save your favorite providers and plan your perfect event
            </p>
          </div>
          ...
          <div className="mt-10 space-y-4">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-[#44646c]/10 flex items-center justify-center shrink-0">
                <Heart className="w-5 h-5 text-[#44646c]" />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-900">Save your favorites</p>
                <p className="text-sm text-gray-500">Keep track of providers you love</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-[#44646c]/10 flex items-center justify-center shrink-0">
                <CalendarCheck className="w-5 h-5 text-[#44646c]" />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-900">Book with ease</p>
                <p className="text-sm text-gray-500">Request quotes and schedule events</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-[#44646c]/10 flex items-center justify-center shrink-0">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Leave reviews</p>
